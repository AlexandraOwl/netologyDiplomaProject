...
import ru.netology.models.DebitRequest;
...
public class SQLHelper {
    ...
    public String getPaymentStatus() {
        ...
        try (var connect = getConnection()) {
            var paymentStatus = runner.query(connect, payStatus, new BeanHandler<>(DebitRequest.class));
    ...
    public String getPaymentAmount() {
        ...
        try (var connect = getConnection()) {
            var paymentAmount = runner.query(connect, payAmount, new BeanHandler<>(DebitRequest.class));
